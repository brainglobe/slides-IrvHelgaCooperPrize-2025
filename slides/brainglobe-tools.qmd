...
::: {.notes}
Kim mouse atlas - incorporates Paxton atlas, with extra delineations in the striatum based on functional data.
:::
...
## 
![](img/neuropixels.png){.absolute right="20%" top="15%" width="60%"}
...
##
![](img/Han_2018_ext_1.jpg){.absolute left="10%" top="8%" width="80%"}
...
![](img/brainrender_still.png){.absolute top="20%" width="70%" left="12.5%"}
