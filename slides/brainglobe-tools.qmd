...
## Version 2
- Ensure everything is packaged and documented
- Ensure everything is easy to install and use
- More atlases (new atlases being added)
- GUI (napari integration etc)
...
- Number of issues for new atlases
...
## BrainGlobe Atlas API V2
- Cloud optimised atlases (OME-Zarr etc)
- Decouple all parts of an atlas
- Allows "custom" atlases to be built from different parts
